...
# file path
file_path_raw <- "C:/Users/dhoevers/Documents/03. Knowledge/01. Data Science/09.Capstone/00_source_data/"
file_path <- "C:/Users/dhoevers/Documents/03. Knowledge/01. Data Science/09.Capstone/Capstone_Project/00_created_data/"

## sample size
factor <- 0.01 # 1%

## twitter
con <- file(paste0(file_path_raw, "en_US.twitter.txt"), "r")
...
## blog
con <- file(paste0(file_path_raw, "en_US.blogs.txt"), "r")
...
## news
con <- file(paste0(file_path_raw, "en_US.news.txt"), "r")
...
# write to txt
saveRDS(uni, paste0(file_path, "ng_uni_1.rData"))
saveRDS(bi, paste0(file_path, "ng_bi_1.rData"))
saveRDS(tri, paste0(file_path, "ng_tri_1.rData"))
saveRDS(quad, paste0(file_path, "ng_quad_1.rData"))
